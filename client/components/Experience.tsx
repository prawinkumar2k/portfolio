  ...
  return (
    <section id="experience" className="py-3 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-xl font-bold text-[#000000e6] mb-6">Experience &amp; Education</h2>

          <div className="space-y-0 divide-y divide-[#F3F2EF]">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-2 mb-1.5">
                      <div>
                        <h3 className="text-[15px] font-semibold text-[#000000e6] leading-snug">{item.title}</h3>
                        <p className="text-sm font-medium text-[#0A66C2] mt-0.5">{item.company}</p>
                      ...
                      <span
                        ...
                        style={{
                          background: item.type === "work" ? "#EFF6FF" : item.type === "education" ? "#FFFBEB" : "#F5F3FF",
                          color: item.type === "work" ? "#0A66C2" : item.type === "education" ? "#D97706" : "#4338CA",
                          border: item.type === "work" ? "1px solid #BFDBFE" : item.type === "education" ? "1px solid #FDE68A" : "1px solid #C7D2FE",
                        }}
                      >
                    ...
                    <ul className="space-y-1.5 mb-3">
                      {item.bullets.map((bullet, bIdx) => (
                        <li key={bIdx} className="flex gap-2 text-sm text-[#000000b3] leading-relaxed">
                          <span className="w-1 h-1 rounded-full bg-[#0A66C2] mt-2 flex-shrink-0" />
                          {bullet}
                        </li>
                      ))}
                    </ul>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {item.technologies.map((tech) => (
                        <span
                          ...
                          style={{ background: "#F3F2EF", color: "#444444", border: "1px solid #E0DED9" }}
                        >
                          {tech}
                        </span>
                      ))}
